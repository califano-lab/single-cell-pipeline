...
* viper (newest version available)
* cluster
* ggplot2
* ggpubr
* umap
...
```{r eval = FALSE}
c1.net <- RegProcess('tutorial/pbmc-r2-c1_finalNet.tsv', r1.clustMats[[1]], 
                     out.dir = 'tutorial/', out.name = 'pbmc-r2-c1_')
c2.net <- RegProcess('tutorial/pbmc-r2-c2_finalNet.tsv', r1.clustMats[[2]], 
                     out.dir = 'tutorial/', out.name = 'pbmc-r2-c2_')
c3.net <- RegProcess('tutorial/pbmc-r2-c3_finalNet.tsv', r1.clustMats[[3]], 
                     out.dir = 'tutorial/', out.name = 'pbmc-r2-c3_')
```
