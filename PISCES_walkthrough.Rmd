...
These clusters will provide specific information about the activity of these markers across all the cells.
 ...
 will be informative Below, we have generated plots of the activity of several canonical markers typically used to separate PBMC's in gene expression space:
