#Step 2 of single cell pipeline
#SampleLevelExpressionAnalysis.r
#input file - *cpm.rda, annoFile.txt (optional)
#output files - *_pca_exp.rda, *_mds_pca_exp.rda, *_Quality_SampleLevelExpressionAnalysis.pdf, *_Sample_SampleLevelExpressionAnalysis.pdf, *_Anno_SampleLevelExpressionAnalysis.pdf, *_iterClust_SampleLevelExpressionAnalysis.pdf

#####--------------------------------------Section 1-------------user messages------------------------------------------########
#rmarkdown::render("SampleLevelExpressionAnalysis.R", "pdf_document")
message("==========")
message("Description:")
...
message("cluster, iterClust, made4")#libraries
...
#packages(optional if installed in local R)
...
plot(mds_pca_exp, xlab = "MDS-1", ylab = "MDS-2", cex = 0.5, pch = 16,
     col = cat[as.factor(sapply(strsplit(rownames(mds_pca_exp), split = "_"), function(x) x[1]))], main = "Samples")#mds
...
plot(mds_pca_exp, xlab = "MDS-1", ylab = "MDS-2", col = geneColor(exp), cex = 0.5, pch = 16, main = "# Genes")#mds_pca
